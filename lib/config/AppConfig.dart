...
const String APP_NAME = 'Likemind';

const Color kPrimaryColor = Color(0xFF480000); // or Colors.red

// The text that will be sent when sharing the app
const String SHARE_TEXT = 'LikeMind';

// Android Google Play Store link URL
const String ANDROID_SHARE_URL =
    'https://play.google.com/store/apps/details?id=com.likemind.byarijeet';
